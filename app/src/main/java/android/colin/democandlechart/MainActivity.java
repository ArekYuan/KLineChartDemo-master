...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadChartData(int colorMa5, int colorMa10, int colorMa20) {
        ...
        /*k line*/
        CandleData candleData = generateCandleData(candleEntries,xVals);
     ...
     * @return
     */
    private CandleData generateCandleData(List<CandleEntry> candleEntries,ArrayList<String> xVals ) {
